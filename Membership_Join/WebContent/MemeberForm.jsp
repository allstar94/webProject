               ...
               <tbody class="tbody">
                  ...
                  <tr>
                     ...
                     <td><input type="text" name="mem_id"
                        placeholder="6자 이상의 영문자와 숫자" required autofocus /> <input
                        type="button" value="ID중복확인" onclick="idCheck(mem_id.value)" />
                     </td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td><input type="password" name="mem_passwd" maxlength="12"
                        minlength="8" required /> <span>8~12자리의 영문 대문자와 숫자,
                           특수문자만 입력</span></td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td><input type="text" name="mem_nickname" maxlength="12"
                        minlength="2" /> <span>2~8자리의 한글로만 입력</span></td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td><input type="text" name="mem_num1" maxlength="6"
                        ...
                        type="button" value="주민번호 정상 유무 체크" onclick="juminCheck(mem_num1.value, mem_num2.value)" /></td>
                  </tr>
                  <tr>
                        ...
                        <div class="inputArea">
                           ...
                           <p>
                              <input type="text" name="userAddr1" id="address" size="100"
                                 ...
                                 id="extraAddress" size="48" placehilder="참고항목" (도로명인 경우:
                                 지역이름과 아파트이름)"/> <input type="text" name="userAddr2"
                                 id="detailaddress" size="45" placeholder="상세주소" (아파트 동호수 또는
                                 빌딩이름 입력하세요!)"/>
                           </p>
                           <div id="layer"
                  ...
                  <tr>
                     <td colspan="2"><input type="submit" value="회원가입 등록" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
